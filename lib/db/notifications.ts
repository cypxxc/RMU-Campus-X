...
class NotificationsApi {
  ...
  async createNotification(notificationData: Omit<AppNotification, "id" | "createdAt" | "isRead">) {
  ...
  async deleteUserNotificationsByAdmin(
    userId: string,
...
export const getNotifications = async (
  ...
  notificationsApi.getNotifications(_userId, options)
...
export const markAllNotificationsAsRead = async (_userId: string) =>
  notificationsApi.markAllNotificationsAsRead(_userId)
...
export const deleteUserNotificationsByAdmin = async (
  ...
  return notificationsApi.deleteUserNotificationsByAdmin(userId, options)
}

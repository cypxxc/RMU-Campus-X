...
export class ReportTargetResolverService {
...
const reportTargetResolverService = new ReportTargetResolverService()
...
export async function resolveReportTarget(
  ...
  return reportTargetResolverService.resolveReportTarget(input, context, deps)
}

...
class DateUtilsService {
  ...
  toDateStr(value: unknown, locale: "th" | "en"): string {
  ...
  formatDate(value: unknown, locale: "th" | "en"): string {
    const d = this.toDate(value)
    if (!d) return "-"
    return d.toLocaleString(locale === "th" ? "th-TH" : "en-US", {
      dateStyle: "medium",
...
export function toDate(value: unknown): Date | null {
  return dateUtilsService.toDate(value)
}

export function toDateStr(value: unknown, locale: "th" | "en"): string {
  return dateUtilsService.toDateStr(value, locale)
}

export function formatDate(value: unknown, locale: "th" | "en"): string {
  return dateUtilsService.formatDate(value, locale)
}

export function toDateTimeLocal(value: unknown): string {
  return dateUtilsService.toDateTimeLocal(value)
}

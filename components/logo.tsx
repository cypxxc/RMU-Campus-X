...
export function Logo({ size = "md", showIcon = true, href = "/dashboard", className = "" }: LogoProps) {
  const sizes = {
    sm: { container: "gap-2", icon: "h-7 w-7", iconPx: 28, text: "text-base" },
    md: { container: "gap-2.5", icon: "h-9 w-9", iconPx: 36, text: "text-xl" },
    lg: { container: "gap-3", icon: "h-14 w-14", iconPx: 56, text: "text-3xl" },
  }

...
class AdminItemController {
  async get(request: NextRequest, params: Promise<{ id: string }>) {
    ...
    try {
      ...
      return errorResponse(AdminErrorCode.INTERNAL_ERROR, 'Failed to fetch item', 500)
    }
  }
  ...
  async delete(request: NextRequest, params: Promise<{ id: string }>) {
    ...
    try {
      ...
      return errorResponse(AdminErrorCode.INTERNAL_ERROR, 'Failed to delete item', 500)
    }
  }
}

const controller = new AdminItemController()

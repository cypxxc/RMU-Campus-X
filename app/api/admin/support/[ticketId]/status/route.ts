...
class AdminSupportTicketStatusController {
  async patch(request: NextRequest, params: Promise<{ ticketId: string }>) {
...
const controller = new AdminSupportTicketStatusController()
